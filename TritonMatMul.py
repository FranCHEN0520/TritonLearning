...
def matmul_kernel(
    ...
    # 计算每个组中的总 PID 数量，GROUP_SIZE_M 是每组处理的行块数，乘以列方向的 PID 数量 num_pid_n
    num_pid_in_group = GROUP_SIZE_M * num_pid_n
    # 根据当前 PID 计算组 ID。将 PID 除以每组的 PID 数量，以确定当前 PID 所属的组
...
benchmark.run(show_plots=True, print_data=True, save_path='./output_matmul')
